...
<html lang="en">
  <head>
    ...
    <!-- NProgress -->
    <link href="{{ asset('dashboard/css/nprogress.css') }} " rel="stylesheet">
    <!-- Animate.css -->
            ...
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  ...
                  <p>©2025 All Rights Reserved. Gentelella Alela! is a Bootstrap 3 template. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
